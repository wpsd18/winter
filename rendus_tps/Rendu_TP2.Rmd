...
* Calculer le nombre moyen de prédictions correctes effectuées dans l'ensemble `tit_train` en considérant les fréquences de survies conditionnelles aux variables `gender` et `child`. Représenter les résultats sous forme de matrice de confusion.
