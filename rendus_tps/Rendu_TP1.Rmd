...
* Pour tout vecteur contenu dans l'objet `x` ci-dessous, calculer le carré de la distance de Mahanalobis séparant ce vecteur au centre de la classe à laquelle il appartient. 
