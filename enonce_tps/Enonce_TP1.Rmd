...
* Pour tout vecteur contenu dans l'objet `x`, calculer deux vecteurs d1 et d2 dont les composantes sont le carré de la distance de Mahalanobis séparant le vecteur du centre de la classe 1 et de la classe 2 respectivement. Compléter le code suivant.
