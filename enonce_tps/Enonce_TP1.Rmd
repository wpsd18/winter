...
* Calculer la valeur moyenne du carré de la distance de Mahanalobis entre chaque vecteur simulé dans l'objet `x0` et de centre de `x` (pour la matrice $C$). Compléter le code suivant
