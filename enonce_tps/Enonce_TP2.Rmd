...
* Quelle valeur de $L$ correspond à une prédiction au hasard (pile ou face) ?

```{r}
# logloss quand p =1/2
# p = 1/2
# L =
  print("On tire la survie à pile ou face")
  cat("logloss: ", L)
```
...
#  p = mean(compléter)
#  L =
    print("On tire la survie suivant la probabilité globale de survie")
    cat("logloss: ", L)
```
