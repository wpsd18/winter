...
- Un "objet" R sauvé sous forme compressée contenant le modèle choisi pour être évalué par l'enseignant sur l'ensemble test. Le fichier compressé devra être sauvé sous le format RDS son intitulé devra être personnalisé sous la forme "my_login_bestmodel.RDS" (voir les exemples à la fin du TP).
...
## Exercice unique: Défi "analyse de sentiments"
