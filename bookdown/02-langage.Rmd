...
On pourra alors corriger les erreurs éventuelles. Si le second animal est un perroquet, il suffit de modifier l'argument de la liste  
...
Si on souhaite calculer la moyenne du sinus de 10000 nombres aléatoires pris entre 0 et 2, il suffit de lire la phrase à l'envers et d'écrire
...
Remarquons que le résultat produit est un peu différent.
