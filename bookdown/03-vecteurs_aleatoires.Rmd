...
* Les lois des variables d'un vecteur aléatoire s'appellent les lois *marginales*. 

* Dans un vecteur aléatoire, les lois de variables sachant d'autres variables sont des *lois conditionnelles*. Elle sont obtenues en faisant des rapports de lois marginales. 
...
* En dimension $D\geq 1$, la matrice de covariance résume la variabilité des observations dans leur ensemble. Cette matrice est symétrique et ses valeurs propres sont strictement positives. En dimension 1, la matrice de covariance correspond à la variance.
