...
$$
\mathbb{E} [(\sum_{i=1}^n f(x_i)/n - \mathbb{E} [f(x)])^2] = {\rm var} [\sum_{i=1}^n f(x_i)/n] = \frac1n {\rm var}[f(x)] \to 0 \, .
$$
...
Par exemple, considérons un vecteur à 4 coordonnées. La loi marginale du couple $(x_1,x_2)$ sera donnée par l'intégrale suivante
