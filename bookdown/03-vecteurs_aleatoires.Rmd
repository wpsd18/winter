...
Une loi de probabilité représente un modèle idéalisé de la répartition (ou distribution) d'une variable aléatoire. Ce modèle correspond à la répartition des valeurs d'une variable dans une population de taille infiniment grande. 

Dans les applications pratiques, il est impossible d'échantillonner l'ensemble de la population, et l'on ne dispose que d'un échantillon de taille finie, égale à $n$. Cet échantillon peut être vu comme $n$ tirages de la variable étudiée selon la loi de densité $p(x)$. Les tirages sont généralement indépendants. 
...
### Espérance conditionnelle (sauter, voir plus loin)
