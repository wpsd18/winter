...
Rappeler l'interprétation de cette grandeur en terme de perte d'information. À l'aide du théorème de transfert, démontrer que 
...
D_{KL}( q \|  p ) = - h(q) + h(p) \, . 
$$
Pour cela, on se souviendra que la variance de la loi $q$ est égale à $\sigma^2$ par hypothèse.
